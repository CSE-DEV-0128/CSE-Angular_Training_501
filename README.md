# Angular Boot Camp example: route-parameters
...
**[StackBlitz for route-parameters](https://stackblitz.io/github/AngularBootCamp/route-parameters)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/route-parameters.git
cd route-parameters
npm install
npm start
```
